 ...
 */
final class Version20211005141937 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, email, roles, password, username, firstname, lastname FROM user');
        ...
        $this->addSql('INSERT INTO user (id, email, roles, password, username, firstname, lastname) SELECT id, email, roles, password, username, firstname, lastname FROM __temp__user');
